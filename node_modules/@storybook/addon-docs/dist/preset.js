import CJS_COMPAT_NODE_URL_m9b2ghz2h from 'node:url';
import CJS_COMPAT_NODE_PATH_m9b2ghz2h from 'node:path';
import CJS_COMPAT_NODE_MODULE_m9b2ghz2h from "node:module";

var __filename = CJS_COMPAT_NODE_URL_m9b2ghz2h.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_m9b2ghz2h.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_m9b2ghz2h.createRequire(import.meta.url);

// ------------------------------------------------------------
// end of CJS compatibility banner, injected by Storybook's esbuild configuration
// ------------------------------------------------------------
import "./_node-chunks/chunk-EJRRZJFL.js";
...
async function webpack(webpackConfig = {}, options) {
  let { module = {} } = webpackConfig, { csfPluginOptions = {}, mdxPluginOptions = {} } = options, enrichCsf = await options.presets.apply("experimental_enrichCsf"), rehypeSlug = (await import("./_node-chunks/rehype-slug-NWINOLPF.js")).default, rehypeExternalLinks = (await import("./_node-chunks/rehype-external-links-5VYHHWAF.js")).default, mdxLoaderOptions = await options.presets.apply("mdxLoaderOptions", {
    ...mdxPluginOptions,
    mdxCompileOptions: {
...
var docs = (input = {}, options) => {
  ...
  let { plugins = [] } = config, { mdxPlugin } = await import("./_node-chunks/mdx-plugin-2527CPDG.js"), { react, reactDom, mdx } = await getResolvedReact(options), packageDeduplicationPlugin = {
