...
import {
  compile
} from "./chunk-2WWA5FN2.js";
import "./chunk-VTKYNFEJ.js";
import "./chunk-K6EKGKFL.js";
import {
  __commonJS,
  __toESM
} from "./chunk-EJRRZJFL.js";
...
async function mdxPlugin(options) {
  let filter = createFilter(/\.mdx$/), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-NWINOLPF.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-5VYHHWAF.js")).default;
  return {
