import CJS_COMPAT_NODE_URL_62figg9psgv from 'node:url';
import CJS_COMPAT_NODE_PATH_62figg9psgv from 'node:path';
import CJS_COMPAT_NODE_MODULE_62figg9psgv from "node:module";

var __filename = CJS_COMPAT_NODE_URL_62figg9psgv.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_62figg9psgv.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_62figg9psgv.createRequire(import.meta.url);
...
import {
  any
} from "./_node-chunks/chunk-7NOXJ6RZ.js";
import {
  DOCUMENTATION_LINK
} from "./_node-chunks/chunk-XPCL6MSO.js";
import {
  require_dist
} from "./_node-chunks/chunk-IKO4XDTM.js";
import {
  dirname,
  normalize,
  relative,
  resolve
} from "./_node-chunks/chunk-PXTB3Z6J.js";
import {
  require_compare,
  require_constants,
  require_debug,
  ...
  require_re,
  require_semver
} from "./_node-chunks/chunk-EKM4RUQ2.js";
import {
  __commonJS,
  __toESM
} from "./_node-chunks/chunk-M5SV5NPD.js";
...
async function getTemplatePath(name) {
  switch (name) {
    case "vitest.config.template":
      return import("./_node-chunks/vitest.config-CI4OHIXS.js");
    case "vitest.config.4.template":
      return import("./_node-chunks/vitest.config.4-IG3PMB56.js");
    case "vitest.config.3.2.template":
      return import("./_node-chunks/vitest.config.3.2-QMYMDCAK.js");
    case "vitest.workspace.template":
      return import("./_node-chunks/vitest.workspace-NGT3ZVLN.js");
    default:
